...
A lightweight WordPress plugin for a floating WhatsApp chat button.

## Files

- `advanced-whatsapp-chat-for-wordpress.php` (main plugin loader)
- `includes/class-awcwp-settings.php` (admin settings page)
- `assets/css/awcwp-chat.css` (styles)
- `assets/js/awcwp-chat.js` (button behavior)
